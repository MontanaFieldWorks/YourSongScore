...
FIELD DEFINITION - melodicStaging (part of instrumentalStagingSubs): despite its name, this judges stereo placement/panning distribution of instruments, not melody. IMPORTANT - a real, precomputed measurement will be provided above as 'Measured Melodic Staging Score' (0-100, based on real measured variance in the stereo pan balance over time - higher means instruments genuinely occupy distinct places in the stereo field at different times; lower means the mix stays mostly centered with minimal stereo movement).
