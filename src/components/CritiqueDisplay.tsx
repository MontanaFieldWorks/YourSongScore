...
function RoseChart({ data }: { data: { name: string; score: number; color: string; weight?: number }[] }) {
  ...
  return (
    <div className="mt-6 p-4 bg-black/60 rounded-2xl border border-white/5 flex flex-col items-center">
      <span className="text-[12px] font-mono text-slate-500 uppercase tracking-widest block mb-4 text-center font-bold">
      ...
      <div className="grid grid-cols-2 gap-x-4 gap-y-1.5 mt-4 w-full select-none">
        {data.map((item, idx) => (
          <div key={idx} className="flex items-center gap-1.5 text-[12px] font-mono text-slate-400 font-semibold">
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center">
        <span className="text-[14px] font-mono font-bold text-slate-300 uppercase tracking-wide">{label}</span>
      ...
      {expanded && (
        <div className="border-t border-white/5 pt-2.5 flex flex-col gap-1 animate-fadeIn">
          <span className="text-[12px] font-mono text-slate-500 uppercase tracking-wider">How to improve</span>
          <p className="text-[13px] text-slate-400 leading-relaxed">{improve}</p>
        </div>
      )}
      <span className="text-[12px] font-mono text-slate-600 self-end">{expanded ? "CLOSE ↑" : "TAP FOR TIPS ↓"}</span>
    </div>
  );
}
    ...
    return (
      ...
      >
        ...
        <div className="flex-shrink-0 flex flex-col items-center justify-center w-full md:w-36 text-center z-10">
          ...
          <span className={`text-[12px] mt-2 block font-mono font-bold uppercase tracking-widest transition-colors ${
        ...
        <div className="flex-grow flex flex-col justify-center text-left md:pl-4 z-10 w-full sm:w-auto">
          ...
          <div className="bg-[#13161C]/50 border border-white/5 py-1.5 px-3.5 rounded-full flex flex-wrap items-center gap-x-5 gap-y-1.5 mt-3 w-fit">
            {(metric.subParams || []).map((param: any, idx: number) => (
              <div key={idx} className="flex items-center text-[14px] font-medium text-slate-300 select-none">
                <span className="text-blue-400 text-[14px] mr-1.5 font-sans">◇</span>
          ...
          <div className="w-full md:w-72 flex-shrink-0 z-10" onClick={(e) => e.stopPropagation()}>
            {metric.isGold && (
              <div className="flex justify-end mb-1.5 select-none animate-pulse">
                <span className="px-2 py-0.5 bg-amber-500/10 border border-amber-500/40 rounded text-[12px] font-mono font-bold text-amber-400 uppercase tracking-widest leading-none">
                  Key Metric
                </span>
              </div>
            )}
            ...
            >
              ...
              />
              <p className="text-[14px] text-slate-200 leading-relaxed font-semibold relative z-10">
                {metric.callout}
              </p>
            </div>
          </div>
  ...
  const CircleMetricButton = ({ 
    ...
    return (
      <div className="relative">
        ...
        >
          {isGold && (
            <div className="absolute top-1.5 right-2 px-1.5 py-0.5 bg-amber-500/10 border border-amber-500/20 rounded text-[12px] font-mono font-bold text-amber-400 uppercase tracking-widest leading-none z-15">
              Key Metric
            </div>
          )}
          ...
          <span className="text-[12px] text-slate-500 mt-1 block font-mono hover:text-blue-400 transition-colors relative z-10">
    ...
    if (name.toLowerCase().includes("your hero") || genre.includes("retro") || genre.includes("wave") || genre.includes("synth") || subgenre.includes("synth")) {
      return (
        <div className="flex flex-col gap-3 font-sans text-slate-300">
          ...
          <span className="text-[13px] font-mono font-bold text-teal-400 uppercase tracking-widest block mt-1">Four-Step Blueprint to Fix Dynamic Balance &amp; LUFS Power:</span>
          ...
          <div className="mt-6 border-t border-white/5 pt-5 flex flex-col gap-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-[#13161C] p-4 rounded-xl border border-white/5 flex flex-col justify-between">
                <div>
                  <span className="text-[13px] font-mono text-slate-400 uppercase">Integrated Loudness</span>
              ...
              <div className="bg-[#13161C] p-4 rounded-xl border border-white/5 flex flex-col justify-between">
                <div>
                  <span className="text-[13px] font-mono text-slate-400 uppercase">True Peak Level</span>
                  <p className="text-xl font-mono font-black text-white mt-1">
              ...
              <div className="bg-[#13161C] p-4 rounded-xl border border-white/5 flex flex-col justify-between">
                <div>
                  <span className="text-[13px] font-mono text-slate-400 uppercase">Loudness Range (LRA)</span>
                  <p className="text-xl font-mono font-black text-white mt-1">
            ...
            <div className="bg-[#13161C] p-5 rounded-xl border border-white/5">
              <span className="text-[13px] font-mono text-teal-400 uppercase tracking-widest block mb-3 font-semibold">
              ...
              <div className="h-32 w-full bg-[#0A0B0E] rounded-lg p-3 relative flex flex-col justify-end overflow-hidden">
                {critique?.liveMetrics?.calculatedWaveformPoints?.length ? (
                  <>
                    ...
                    <div className="flex justify-between text-[12px] font-mono text-slate-500 mt-2">
                  ...
                  <div className="absolute inset-0 bg-black/75 flex flex-col items-center justify-center rounded-lg border border-dashed border-white/5">
                    ...
                    <span className="text-[13px] font-mono text-slate-400">Awaiting audio analysis...</span>
                  </div>
                )}
                
                <div className="absolute top-2 right-2 text-[12px] font-mono text-pink-400 flex items-center gap-1">
            ...
            <div className="bg-[#13161C]/50 p-4 rounded-xl border border-white/5 flex flex-col gap-3">
              ...
              <div className="border-t border-white/5 pt-3">
                ...
                >
                  ...
                  <span className="text-[12px] font-mono no-underline bg-teal-400/10 border border-teal-500/20 px-1.5 py-0.5 rounded text-teal-400 uppercase tracking-widest leading-none shrink-0">Glossary &rarr;</span>
                </button>
              </div>
        ...
        return (
          <div className="mt-6 border-t border-white/5 pt-5 flex flex-col gap-5">
            ...
            <div className="bg-[#0A0B0E] p-5 rounded-xl border border-white/10 relative overflow-hidden">
              <span className="text-[13px] font-mono text-blue-400 uppercase tracking-wider block mb-1">
                20Hz - 20kHz Soundstage Profile Density
              </span>
              <span className="text-[12px] font-semibold text-slate-500 block mb-4">
              ...
              <div className="h-44 w-full relative flex flex-col justify-between">
                ...
                <div className="absolute top-1 left-[55px] text-[12px] font-mono text-rose-400 bg-rose-955/50 px-2 py-0.5 border border-rose-500/20 rounded">
                  Delta +1.8dB at 180Hz (Bass Overlap / Mud Zone)
                </div>
                <div className="absolute top-16 right-[100px] text-[12px] font-mono text-emerald-400 bg-emerald-955/50 px-2 py-0.5 border border-emerald-500/20 rounded">
                  Delta -0.5dB at 4.5kHz (Optimal Present Vocal Pocket!)
                </div>

                <div className="mt-auto flex justify-between text-[12px] font-mono text-slate-500 pt-2 border-t border-white/5">
        ...
        return (
          <div className="mt-6 border-t border-white/5 pt-5 flex flex-col gap-5">
            ...
            <div className="bg-[#0A0B0E] p-4 rounded-xl border border-white/5">
              <span className={`text-[13px] font-mono ${flowColorClass} uppercase block mb-3 font-semibold`}>
                Song Architecture Phase-Build Model
              </span>
              
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3">
                  <div className="w-20 text-[13px] uppercase font-mono text-slate-400">Verse 1 (0-22s)</div>
                  <div className="flex-1 h-6 bg-blue-500/10 border border-blue-500/20 rounded flex items-center px-2.5 text-[13px] text-blue-400 font-mono justify-between">
                    <span>Harmonic Grounding (82%)</span>
                    <span>Tension: Balanced</span>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-20 text-[13px] uppercase font-mono text-slate-400">Pre-Chorus (22-38s)</div>
                  <div className="flex-1 h-6 bg-purple-500/15 border border-purple-500/30 rounded flex items-center px-2.5 text-[13px] text-purple-400 font-mono justify-between animate-pulse">
                    <span>Ramping Volume Sweep + Uplift Build (88%)</span>
                    <span>Tension: Ramping Up</span>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-20 text-[13px] uppercase font-mono text-slate-400">Chorus Peak (38-1m08s)</div>
                  <div className={`flex-1 h-6 ${flowPillBgClass} rounded flex items-center px-2.5 text-[13px] font-mono justify-between font-bold`}>
        ...
        <div style={{ position: "relative", left: "10px" }} className="bg-[#050608] p-6 rounded-2xl border border-white/10 flex flex-col md:flex-row gap-6 items-start relative overflow-hidden shadow-2xl">
          ...
          <div className="flex-1 w-full pl-3.5">
            ...
            <div className="p-4 bg-[#020203] border border-white/10 rounded-xl">
              <span className={`text-[13px] font-mono uppercase tracking-wider block mb-1 font-bold ${
            ...
            {selectedObj.id === "readiness" && critique?.liveMetrics && (() => {
              ...
              return (
                <div className="mt-3 p-4 bg-[#020203] border border-white/10 rounded-xl">
                  <span className="text-[13px] font-mono uppercase tracking-wider block mb-2 font-bold text-blue-400">
                  ...
                  <p className="text-[13px] text-slate-500 mt-2">Compliance badges only - not scored, not weighted, does not factor into the Engagement Power score.</p>
                </div>
              );
            })()}
                  ...
                  <div key={index} className="flex flex-col gap-2.5 w-full">
                    ...
                    >
                      ...
                      <div className="flex flex-col items-center justify-center p-3 bg-black/60 rounded-xl border border-white/5 w-24 shrink-0 text-center select-none">
                        <span className="text-[12px] font-mono font-bold tracking-wider text-slate-500 uppercase">Subscore</span>
                        ...
                        <span className={`text-[13px] font-mono font-black tracking-wider uppercase mt-1 ${statusColorClass}`}>
                          {statusLabel}
                        </span>
                      </div>
                      ...
                      <div className="flex-grow flex-1 flex flex-col justify-between">
                        <div>
                          <div className="flex items-end justify-between gap-2 border-b border-dotted border-white/15 pb-1 animate-fadeIn">
                            <span className="text-sm font-black text-slate-100 font-sans tracking-tight flex items-baseline gap-2">
                              ...
                              {isLufsRow && (
                                <span className="text-[12px] px-1.5 py-0.5 bg-teal-500/10 text-teal-400 border border-teal-500/20 rounded font-mono font-bold uppercase tracking-widest leading-none">
                                  {lufsOpen ? "Toggled On" : "Click to review"}
                                </span>
                              )}
                            </span>
                            <span className="text-[13px] text-blue-400 font-mono font-bold uppercase tracking-wider leading-none">
                              Weight: {(() => {
                        ...
                        <div className="mt-3.5 p-3.5 bg-black/60 border border-white/5 rounded-xl text-xs text-slate-300 leading-relaxed font-sans shadow-inner relative overflow-hidden">
                          ...
                          <span className="text-[12px] font-mono text-blue-400 font-bold uppercase tracking-widest block mb-1">
          ...
          <div className="w-full md:w-[256px] bg-[#020203] py-5 px-3 rounded-2xl border border-white/10 self-stretch flex flex-col justify-between">
            <div>
              <div className="mb-4">
                <span className="text-[12px] font-mono uppercase tracking-widest text-[#a855f7] block mb-1 font-bold select-none">
                ...
                <div className={`mt-2.5 p-4 rounded-xl flex items-center justify-between border ring-1 relative overflow-hidden transition-all duration-300 ${
                  ...
                  <div className="relative z-10">
                    <span className={`text-[12px] font-mono font-bold uppercase tracking-wider block ${
                  ...
                  <span className={`relative z-10 px-2 py-0.5 rounded-lg text-[12px] font-mono font-bold uppercase tracking-widest shadow-[0_0_10px_rgba(59,130,246,0.4)] ${
            ...
            <div className="mt-4 pt-3.5 border-t border-white/5 flex items-center justify-between text-[13px] font-mono text-slate-500">
    ...
    return (
      <div className="bg-[#13161C] border border-white/10 rounded-[32px] p-6 shadow-2xl relative overflow-hidden flex flex-col gap-6 my-2 scroll-mt-[100px]" id="algotorial-sandbox-panel">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-white/5 pb-5 gap-4 relative z-10">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col text-left">
              <h2 className="text-lg font-bold text-white tracking-wide uppercase flex items-center gap-2">
                ...
                <span className="text-[13px] bg-amber-500/20 border border-amber-500/30 text-amber-500 font-mono tracking-widest px-2 py-0.5 rounded-full">SIMULATION ENGINE</span>
              </h2>
          ...
          <div className="flex items-center gap-2 text-slate-500 text-[14px] font-mono select-none">
          ...
          <div className="bg-[#0A0B0E] border border-white/5 hover:border-white/10 rounded-2xl p-5 flex flex-col justify-between transition-all group shadow-inner min-h-[360px]">
            <div>
              <div className="flex items-center justify-between mb-3 border-b border-white/5 pb-2.5 flex-wrap gap-y-1">
                ...
                <span className="text-[13px] font-mono text-slate-500">Vector Alignment (θ)</span>
                <div className="w-full flex justify-start pl-5 mt-1">
                  <button 
                    onClick={() => onViewDefinition && onViewDefinition("cosine-similarity")}
                    className="text-[12px] text-[#22d3ee] hover:text-white font-mono hover:underline cursor-pointer transition-colors text-left font-bold"
                  >
                    (see explanation)
                  </button>
                </div>
                ...
                {(["today-hits", "discover-weekly", "chill-vibes", "indie"] as const).map((pId) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-2.5 py-1.5 rounded-xl border text-[14px] font-semibold text-left transition-all flex items-center gap-1.5 cursor-pointer select-none ${
                        isSel
            ...
            <div className="flex items-center gap-5 my-0.5" id="vector-plotter-graphics">
              ...
              <div className="relative w-28 h-28 bg-[#0F1116] rounded-full border border-white/5 flex items-center justify-center flex-shrink-0">
                ...
                {/* Latent space labels */}
                <span className="absolute bottom-0 text-[12px] font-mono text-slate-600">VALENCE</span>
                <span className="absolute left-1 top-12 text-[12px] font-mono text-slate-600 rotate-90 origin-left">ENERGY</span>
              </div>

              {/* Angle Description & Formula */}
              <div className="flex-1 flex flex-col text-left gap-1.5 justify-center">
                <span className="text-[13px] font-mono text-blue-400 font-bold bg-blue-600/10 py-0.5 px-2 rounded-md border border-blue-500/15 w-fit">
                  MATCH: {percentageMatch}% COHERENCE
                </span>
                <div className="text-[14px] text-slate-300 font-medium leading-relaxed">
                  Vector Distance θ = {Math.round(Math.acos(cosSimilarity) * (180 / Math.PI))}°
                </div>
                <div className="font-mono text-[12px] text-slate-400 leading-normal">
                ...
                <span className="text-xs font-bold text-white font-sans uppercase flex items-center gap-1.5 leading-none">
                  ...
                  {!hasUserSetMood && (
                    <span 
                      ...
                      style={{ width: "74px", paddingRight: "9px" }}
                    >
                      Needs Your Input
                    </span>
                  )}
                </span>
                <span className="text-[13px] font-mono text-slate-500 flex items-center gap-1">Valence-Energy Affect Space</span>
              </div>
              <p className="text-xs text-slate-400 leading-relaxed mb-4 text-left">
                Defines the song's musical emotion quadrant (Russell's model of affect) derived from theory and lyrics.
              </p>
              <p className="text-[14px] text-slate-500 leading-relaxed mb-3 text-left">
              ...
              <div className="grid grid-cols-2 gap-2 pr-1 relative my-1">
                ...
                >
                  ...
                  <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-amber-500/[0.03] flex items-center justify-center pointer-events-none">
                    <span className="text-[14px] font-mono text-amber-500/50 tracking-widest font-bold">EUPHORIC</span>
                  </div>
                  <div className="absolute top-0 left-0 w-1/2 h-1/2 bg-red-500/[0.03] flex items-center justify-center pointer-events-none">
                    <span className="text-[14px] font-mono text-red-500/50 tracking-widest font-bold">INTENSE</span>
                  </div>
                  <div className="absolute bottom-0 left-0 w-1/2 h-1/2 bg-violet-500/[0.03] flex items-center justify-center pointer-events-none">
                    <span className="text-[14px] font-mono text-violet-500/50 tracking-widest font-bold">MELANCHOLY</span>
                  </div>
                  <div className="absolute bottom-0 right-0 w-1/2 h-1/2 bg-emerald-500/[0.03] flex items-center justify-center pointer-events-none">
                    <span className="text-[14px] font-mono text-emerald-500/50 tracking-widest font-bold">SERENE</span>
                  </div>
                ...
                <div className="flex flex-col text-left justify-center gap-1.5 pl-3">
                  ...
                  <span className="text-[13px] uppercase font-mono font-bold tracking-wider text-pink-400 mt-1">
                    EST. QUADRANT: {
                  ...
                  <p className="text-[13px] text-slate-500 leading-normal mt-1">
                  ...
                  <button
                    ...
                    className="text-[13px] text-slate-600 hover:text-slate-400 underline transition-colors mt-2 text-left block w-fit"
                  >
                    Reset to center
                  </button>
                </div>
          ...
          <div className="bg-[#0A0B0E] border border-white/5 hover:border-white/10 rounded-2xl p-5 flex flex-col justify-between transition-all group shadow-inner min-h-[360px]">
            <div>
              <div className="flex items-center justify-between mb-3 border-b border-white/5 pb-2.5 flex-wrap gap-y-1">
                ...
                <span className="text-[13px] font-mono text-slate-500">Consecutive Variance (s²)</span>
                <div className="w-full flex justify-start pl-5 mt-1">
                  <button 
              ...
              <div className="flex items-center gap-1.5 bg-black/60 p-1 border border-white/5 rounded-xl mb-4">
                {(["uniform", "upbeat", "sudden"] as const).map((mode) => (
                  <button
                    ...
                    className={`flex-1 text-[13px] font-mono font-bold py-1 px-1.5 rounded-lg border transition-all text-center uppercase cursor-pointer select-none ${
            ...
            <div className="flex flex-col gap-3.5 my-1 text-left">
              ...
              <div className="flex items-center justify-between gap-2.5 bg-black/40 border border-white/5 rounded-xl p-3 pr-4">
                <div className="flex flex-col gap-0.5 max-w-[80px]">
                  <span className="text-[12px] font-mono text-slate-500 uppercase tracking-wider leading-none">A: PREVIOUS</span>
                ...
                <div className="flex-1 flex flex-col items-center justify-center">
                  ...
                  <span className="text-[12px] font-mono text-emerald-400 font-bold mt-1.5 leading-none">Simulating...</span>
                </div>

                <div className="flex flex-col gap-0.5 border-x border-white/5 px-3 max-w-[100px]">
                  <span className="text-[12px] font-mono text-blue-400 uppercase tracking-wider leading-none">YOUR TRACK</span>
                ...
                <div className="flex flex-col gap-0.5 max-w-[80px]">
                  <span className="text-[12px] font-mono text-slate-500 uppercase tracking-wider leading-none">B: NEXT</span>
  ...
  const renderRecommenderPredictionPanel = () => {
    return (
            ...
            <div className="relative z-10 flex-1">
              <span className="text-[13px] font-mono tracking-widest text-violet-400 font-bold uppercase block">Predicted Algorithmic Indexing</span>
            ...
            <div className="bg-[#0D0E12] border border-white/5 rounded-2xl p-5 text-left flex flex-col justify-between shadow-md">
              <div>
                <div className="flex items-center justify-between border-b border-white/5 pb-2.5 mb-3">
                  ...
                  <span className="text-[12px] bg-sky-500/10 text-sky-400 font-mono px-2 py-0.5 rounded uppercase font-bold border border-sky-500/15 tracking-widest font-semibold">"Artist Universe"</span>
                </div>
              ...
              <div className="bg-neutral-950 p-4 rounded-xl border border-white/5">
                <span className="text-[12px] font-mono font-semibold text-slate-500 uppercase tracking-widest block mb-2">Target Cluster Alignment:</span>
                ...
                <span className="text-[12px] font-mono font-semibold text-slate-500 uppercase tracking-widest block mb-1">Predicted Sonic Neighbors:</span>
                <div className="flex flex-wrap gap-1.5 mt-2">
                  {sonicNeighbors.map((artist) => (
                    <span 
                      key={artist}
                      className="text-[13px] font-mono text-slate-300 font-bold bg-white/5 border border-white/10 px-2 py-1 rounded-md hover:bg-[#1ed760]/10 hover:border-[#1ed760]/30 hover:text-[#1ed760] hover:-translate-y-0.5 transition-all duration-300 select-none cursor-pointer"
                    >
                      {artist}
                    </span>
                  ))}
            ...
            <div className="bg-[#0D0E12] border border-white/5 rounded-2xl p-5 text-left flex flex-col justify-between shadow-md">
              <div>
                <div className="flex items-center justify-between border-b border-white/5 pb-2.5 mb-3">
                  ...
                  <span className="text-[12px] bg-purple-500/10 text-purple-400 font-mono px-2 py-0.5 rounded uppercase font-bold border border-purple-500/15 tracking-widest font-semibold">Algorithms</span>
                </div>
                <p className="text-xs text-slate-400 leading-relaxed mb-4">
                ...
                {[
                  ...
                  <div key={item.name} className="bg-neutral-950 p-3.5 rounded-xl border border-white/5 flex gap-3 items-center">
                    <div className="relative flex items-center justify-center flex-shrink-0">
                      ...
                      <span className="absolute text-[13px] font-mono font-black text-white">{item.score}%</span>
                    </div>
                    <div className="flex flex-col text-left">
                      <span className="text-[13px] font-bold text-white font-sans">{item.name}</span>
                      <span className="text-[12px] text-slate-500 mt-0.5 leading-none font-mono font-semibold">{item.desc}</span>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="bg-[#0D0E12] border border-white/5 rounded-2xl p-5 text-left shadow-md">
            <div className="flex items-center justify-between border-b border-white/5 pb-2.5 mb-4">
              ...
              <span className="text-[12px] bg-amber-500/10 text-amber-500 font-mono px-2 py-0.5 rounded uppercase font-bold border border-amber-500/15 tracking-widest font-semibold">Collaborative Filter</span>
            </div>
            <p className="text-xs text-slate-400 leading-relaxed mb-4">
            ...
            <div className="text-xs text-[#1DB954]/90 leading-relaxed bg-[#1DB954]/5 border border-[#1DB954]/15 p-4 rounded-xl mb-5 space-y-2">
              <div>
                <span className="text-white font-extrabold font-sans uppercase text-[13px] block mb-1">Algorithmic Performance Analysis:</span>
              ...
              <div className="pt-2 border-t border-[#1DB954]/15 text-slate-300/90 font-normal">
                {(() => {
                  ...
                  return (
                    <>
                      <span className="text-white font-extrabold font-sans uppercase text-[13px] block mb-1">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col gap-0.5">
                      ...
                      <p className="text-[13px] text-slate-400 leading-relaxed mt-0.5">{displayDesc}</p>
                    </div>
                  </button>
                );
              })}
        ...
        {(
            ...
            {(critique?.vibe?.genre || critique?.vibe?.subgenre) && (
              <div className="flex items-center gap-2 mt-1">
                <span className="text-[12px] font-mono text-slate-500 uppercase tracking-widest">Target Profile:</span>
                <span className="text-[12px] font-mono font-bold text-emerald-400 uppercase tracking-widest px-2 py-0.5 rounded-full border border-emerald-500/20 bg-emerald-500/5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div key={item.key} className="bg-[#13161C] border border-white/5 p-4 rounded-xl flex flex-col justify-between hover:border-[#1ed760]/20 transition-all font-sans">
                    <div>
                      <div className="flex justify-between items-baseline mb-1">
                        <div className="flex items-center gap-1 flex-wrap">
                          <span className="text-[13px] font-mono text-slate-400 uppercase tracking-widest font-semibold">{item.name}</span>
                          {item.source === "audio" ? (
                            <span className="text-[12px] font-mono text-cyan-500/70 border border-cyan-500/20 px-1 py-0.5 rounded uppercase tracking-wide ml-1 normal-case font-medium">
                              ⬡ audio
                            </span>
                          ) : item.source === "ai-real" ? (
                            <span className="text-[12px] font-mono text-purple-400/80 border border-purple-500/20 px-1 py-0.5 rounded uppercase tracking-wide ml-1 normal-case font-medium">
                              ✦ ai
                            </span>
                          ) : (
                            <span className="text-[12px] font-mono text-slate-600 border border-white/5 px-1 py-0.5 rounded uppercase tracking-wide ml-1 normal-case font-medium">
                              est
                            </span>
                          )}
                        </div>
                      ...
                      <div className="flex justify-between items-center text-[12px] font-mono text-slate-500 mb-2 mt-1">
                    ...
                    <div className="mt-2 text-left">
                      <div className="flex items-center gap-1 mb-1.5">
                        <span className={`text-[12px] font-mono font-black px-1.5 py-0.5 rounded uppercase flex items-center gap-1 font-bold border ${tier.badgeClass}`}>
                        ...
                        {(() => {
                          ...
                          return (
                            <span className={`${tier.textClass} font-medium flex flex-col gap-2`}>
                              ...
                              {fixFeedback && (
                                <span className={`block mt-1 p-2 rounded font-sans text-[13px] leading-relaxed ${tier.badgeClass}`}>
              ...
              <div className={`p-4 rounded-xl border flex flex-col justify-between transition-all ${
                ...
                <div>
                  <div className="flex justify-between items-baseline mb-1">
                    <span className="text-[13px] font-mono text-slate-400 uppercase tracking-widest">True Peak Limiter Audit</span>
                    <span className={`text-[12px] font-mono font-black px-2 py-0.5 rounded ${spotifyTruePeak > -1.0 ? "bg-amber-500/10 text-amber-400 border border-amber-500/15" : "bg-emerald-500/10 text-[#1ed760] border border-emerald-500/15"}`}>
                ...
                <p className="text-[13px] leading-relaxed mt-1 font-sans">
                  {spotifyTruePeak > -1.0 ? (
            ...
            <span className="text-[#1ed760] block mt-1 text-[14px] leading-relaxed bg-[#1ed760]/5 border border-[#1DB954]/15 p-3 rounded-xl shadow-inner">
              <strong className="font-extrabold uppercase text-[13px] block mb-1">💡 CRITICAL TRADING WINDOW RULE (±3% CORRIDOR):</strong> 
            ...
            <div className="border-t border-white/5 pt-3.5 mt-2 flex flex-col sm:flex-row items-center justify-between gap-3 text-[14px] font-mono text-slate-400">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <strong className="text-white bg-neutral-950 px-2.5 py-1 border border-white/10 rounded-md font-sans flex items-center">
                      ...
                      {critique.liveMetrics.calculatedTimeSignatureConfidence !== undefined && (
                        <span className={`text-[12px] font-mono ml-1 ${
                ...
                {(critique?.liveMetrics?.calculatedEndOfFadeIn !== undefined || critique?.liveMetrics?.calculatedStartOfFadeOut !== undefined) && (
                  <div className="flex items-center gap-1.5">
                    ...
                    <strong className="text-white bg-neutral-950 px-2.5 py-1 border border-white/10 rounded-md font-sans flex items-center gap-2">
                      ...
                      {critique?.liveMetrics?.calculatedEndOfFadeIn !== undefined && critique.liveMetrics.calculatedEndOfFadeIn === 0 && (
                        <span className="text-[12px] font-mono text-slate-500">No fade-in</span>
                      )}
                      ...
                      {critique?.liveMetrics?.calculatedStartOfFadeOut !== undefined && critique?.liveMetrics?.calculatedDuration !== undefined && critique.liveMetrics.calculatedStartOfFadeOut >= critique.liveMetrics.calculatedDuration && (
                        <span className="text-[12px] font-mono text-slate-500">No fade-out</span>
                      )}
                    </strong>
                  </div>
                )}
              </div>
              <div className="text-[13px] text-slate-500 italic font-sans font-medium">
    ...
    return (
      <div className="flex flex-col gap-6 w-full text-slate-300" id="azimuth-profiler-panel-section">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 bg-[#060a12]/80 p-3 rounded-2xl border border-white/5">
          <div className="flex flex-col text-left">
            <span className="text-[13px] font-mono text-cyan-400 tracking-wider font-semibold uppercase">Soundstage Calibration View</span>
          ...
          <div className="xl:col-span-4 flex flex-col gap-4 self-stretch justify-between">
            <div className="bg-neutral-900 border border-white/5 rounded-2xl p-5 flex-1 flex flex-col justify-between text-left relative overflow-hidden min-h-[300px]">
              <div className="flex flex-col gap-3.5">
                <span className="text-[12px] font-mono tracking-widest text-[#94a3b8] font-bold uppercase border-b border-white/10 pb-1.5 block">
                ...
                <div className="flex flex-col gap-1 border-t border-white/[0.04] pt-2.5">
                  ...
                  <p className="text-[13px] text-slate-400 leading-normal font-sans">
                    {azimuthRefMode === "benchmark"
              ...
              <div className="bg-slate-950 border border-white/5 p-3 rounded-xl mt-4 text-[13px] text-slate-400 leading-relaxed font-semibold">
                <span className="text-cyan-400 block mb-0.5 uppercase tracking-wider font-mono text-[12px]">DIAGNOSTIC RECOMMENDATION:</span>
            ...
            <div className="bg-neutral-950 border border-white/10 p-4.5 rounded-2xl flex items-center justify-between gap-4 select-none">
              <div className="text-left flex-1">
                <span className="text-[12px] font-mono text-cyan-400 font-bold uppercase block tracking-wider">Soundstage Match Rate</span>
              ...
              <div className="bg-[#0b1322] border border-cyan-500/20 p-3 rounded-xl text-center shadow-lg min-w-[100px] flex-shrink-0 flex flex-col justify-center items-center">
                <span className="text-[13px] font-bold font-mono text-[#06b6d4]">AZIMUTH INDEX</span>
    ...
    <div className="flex flex-col gap-6" id="critique-display-container">
      ...
      <div className="bg-[#0D0E12] border border-white/15 rounded-3xl p-6 shadow-2xl relative overflow-hidden flex flex-col lg:flex-row lg:items-center justify-between gap-6 ring-1 ring-white/5 mt-[-12px]">
        ...
        <div className="flex flex-col gap-5 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 flex-wrap mt-1">
            ...
            >
              <span className="text-[12px] uppercase font-mono tracking-wider text-slate-500 font-bold">Core Genre Profile:</span>
            ...
            <div 
              ...
              className="bg-[#11131A] px-4 py-3 rounded-xl border border-blue-500/25 shadow-[0_4px_20px_rgba(0,0,0,0.4)] hover:border-blue-500/50 transition-all flex flex-col items-start gap-1 justify-center whitespace-nowrap min-w-fit"
            >
              <span className="text-[12px] uppercase font-mono tracking-wider text-slate-500 font-bold">Sub-Genre &amp; Dynamic Style:</span>
              <div className="font-bold text-white text-sm flex items-center gap-2">
        ...
        {audioSourceUrl && (
          <div className="flex items-center gap-3 bg-neutral-950 border border-white/15 p-3 rounded-xl relative z-10 shadow-inner" id="header-audio-player">
            ...
            <div className="flex flex-col pr-4">
              <span className="text-[13px] font-mono text-slate-400 uppercase flex items-center gap-1">
      ...
      <div className="flex flex-col gap-4 mt-4 mb-[-9px]" id="kpi-category-selectors">
        ...
        <div className="flex relative mt-4" id="critique-page-layout">
          ...
          >
            ...
            <div className="flex items-center justify-between px-2 py-1 mb-2">
              <span className="text-[13px] font-mono text-slate-600 tracking-widest uppercase">
                {sidebarCollapsed ? '' : 'Menu'}
              </span>
              <button
                onClick={() => setSidebarCollapsed(!sidebarCollapsed)}
                className="p-1 rounded-md bg-neutral-900/80 border border-white/5 text-slate-500 hover:text-slate-300 transition-colors cursor-pointer text-[14px] font-mono leading-none"
              >
                {sidebarCollapsed ? '»' : '«'}
              </button>
            </div>
                ...
                {!sidebarCollapsed && (
                  <>
                    <div className="flex flex-col min-w-0 truncate">
                      <span className="text-[14px] font-mono font-bold uppercase tracking-widest leading-none">STREAMING READINESS</span>
                    </div>
                  </>
                )}
              </div>
            ...
            >
              ...
              <div className="flex items-center gap-2.5 min-w-0 w-full">
                ...
                {!sidebarCollapsed && (
                  <>
                    <div className="flex flex-col min-w-0 truncate">
                      <span className="text-[14px] font-mono font-bold uppercase tracking-widest leading-none">SONIC SOUNDPRINT</span>
                    </div>
                  </>
                )}
              </div>
            ...
            >
              ...
              <div className="flex items-center gap-2.5 min-w-0 w-full">
                ...
                {!sidebarCollapsed && (
                  <>
                    <div className="flex flex-col min-w-0 truncate">
                      <span className="text-[14px] font-mono font-bold uppercase tracking-widest leading-none">STRUCTURAL ENGAGEMENT</span>
                    </div>
                  </>
                )}
              </div>
            ...
            >
              ...
              <div className="flex items-center gap-2.5 min-w-0 w-full">
                ...
                {!sidebarCollapsed && (
                  <>
                    <div className="flex flex-col min-w-0 truncate">
                      <span className="text-[14px] font-mono font-bold uppercase tracking-widest leading-none">COMPOSITIONAL DEPTH</span>
                    </div>
                  </>
                )}
              </div>
          ...
          <div className="flex-1 min-w-0 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-4">
                ...
                >
                  ...
                  <div className="relative z-10 p-7 flex flex-col gap-3">
                    <span className="text-[13px] font-mono font-bold text-blue-400 uppercase tracking-[0.2em]">Category</span>
                    ...
                    <div className="flex gap-2 mt-2 flex-wrap">
                      {["Commercial Impact", "Streaming Alignment", "Algo Sandbox"].map(tag => (
                        <span key={tag} className="text-[12px] font-mono text-blue-400/70 border border-blue-500/25 px-2.5 py-1 rounded-full">{tag}</span>
                      ))}
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  {/* Content */}
                  <div className="relative z-10 p-7 flex flex-col gap-3">
                    <span className="text-[13px] font-mono font-bold text-[#46F4CD] uppercase tracking-[0.2em]">Category</span>
                    ...
                    <div className="flex gap-2 mt-2 flex-wrap">
                      {["Engineering Studio", "Production Quality"].map(tag => (
                        <span key={tag} className="text-[12px] font-mono text-[#46F4CD]/70 border border-[#46F4CD]/25 px-2.5 py-1 rounded-full">{tag}</span>
                      ))}
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  {/* Content */}
                  <div className="relative z-10 p-7 flex flex-col gap-3">
                    <span className="text-[13px] font-mono font-bold text-purple-400 uppercase tracking-[0.2em]">Category</span>
                    ...
                    <div className="flex gap-2 mt-2 flex-wrap">
                      {["Arrangement Flow", "Dynamic Modulation", "Climax Trajectory"].map(tag => (
                        <span key={tag} className="text-[12px] font-mono text-purple-400/70 border border-purple-500/25 px-2.5 py-1 rounded-full">{tag}</span>
                      ))}
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  {/* Content */}
                  <div className="relative z-10 p-7 flex flex-col gap-3">
                    <span className="text-[13px] font-mono font-bold text-amber-400 uppercase tracking-[0.2em]">Value Added</span>
                    ...
                    <div className="flex gap-2 mt-2 flex-wrap">
                      {["Music Theory", "Lyrical Impact", "Artistic Impact"].map(tag => (
                        <span key={tag} className="text-[12px] font-mono text-amber-400/70 border border-amber-500/25 px-2.5 py-1 rounded-full">{tag}</span>
                      ))}
                    </div>
                  </div>
                </div>
            ...
            {expandedCategory !== null && (
              <button
                ...
                className="flex items-center gap-2 text-[13px] font-mono text-slate-400 hover:text-white transition-colors cursor-pointer self-start px-3 py-2 bg-neutral-900 border border-white/10 rounded-xl mb-2"
              >
                ← Back to Overview
              </button>
            )}
            ...
            {(expandedCategory === "streaming" || expandedCategory === null) && expandedCategory === "streaming" && (
              ...
              <div className="relative overflow-hidden flex items-center gap-4 pl-5 pr-2 py-3 border-t border-b border-blue-500/20" style={{ background: "linear-gradient(to right, #090b0e 0%, #090b0e 55%, #0d1628 100%)" }}>
                ...
                <span className="relative z-10 text-[12px] font-mono text-slate-500 ml-auto">Algorithmic curation & discovery potential</span>
              ...
              <div className="flex flex-col flex-1 justify-between gap-3 h-full">
                ...
                <div className="flex items-center gap-3" style={{ marginBottom: "-9px" }}>
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[13px] text-slate-500 font-medium">Algorithmic Curation Potential</span>
                  </div>
                </div>
                ...
                <div className={`border-t text-left pt-2 px-0.5 transition-colors ${
                  ...
                  <p className="text-[13px] text-slate-400 leading-relaxed font-semibold" style={{ marginBottom: "0px" }}>
                    ...
                    <span className="block mt-1 text-blue-400/90 font-mono text-[12px] uppercase tracking-wider" style={{ marginBottom: "2px" }}>Predicts first-listen algorithmic scoring and playlist eligibility.</span>
                  </p>
                  <span 
                    style={{ paddingTop: "2px" }}
                    className={`inline-block text-[12px] font-mono tracking-widest px-2 py-0.5 rounded-full border transition-all ${
                    activeCategory === "mainstream"
              ...
              >
                <div style={{ position: "relative", left: "15px", width: "calc(100% - 15px)" }} className="bg-black/80 border border-[#2a7eff] rounded-3xl p-6 shadow-[0_0_35px_rgba(0,0,0,0.95)] flex flex-col gap-5">
                  ...
                  <div style={{ marginTop: "-20px", paddingTop: "11px", paddingBottom: "18px" }} className="flex items-center justify-between border-b border-white/5">
                    ...
                    <span className="text-[13px] font-mono text-slate-500 text-right">
              ...
              <div className="flex flex-col flex-1 justify-between gap-3 h-full">
                ...
                <div className="flex items-center gap-3" style={{ marginBottom: "-9px" }}>
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[13px] text-slate-500 font-medium">First-30-Second Retention Prediction</span>
                  </div>
                </div>
                ...
                <div className={`border-t text-left pt-2 px-0.5 transition-colors ${
                  ...
                  <p className="text-[13px] text-slate-400 leading-relaxed font-semibold" style={{ marginBottom: "0px" }}>
                    ...
                    <span className="block mt-1 text-cyan-400/90 font-mono text-[12px] uppercase tracking-wider" style={{ marginBottom: "2px" }}>Determines whether your track survives the first-30-second skip window that shapes algorithmic trust.</span>
                  </p>
                  <span 
                    style={{ paddingTop: "2px" }}
                    className={`inline-block text-[12px] font-mono tracking-widest px-2 py-0.5 rounded-full border transition-all ${
                  ...
                  <div id="panel-d-skip-completion" className="bg-[#0A0B0E] border border-white/5 rounded-2xl p-5 flex flex-col gap-4 text-left">
                    ...
                    <div className="border-t border-white/5 pt-4">
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="flex items-center justify-between text-[14px] font-mono pl-3">
                        ...
                        <div className="flex items-center justify-between text-[14px] font-mono pt-1 border-t border-white/5">
              ...
              <div className="flex flex-col flex-1 justify-between gap-3 h-full">
                ...
                <div className="flex items-center gap-3" style={{ marginBottom: "-9px" }}>
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[13px] text-slate-500 font-medium">Pillars of Content &amp; Collaborative Filtering</span>
                  </div>
                </div>
                ...
                <div className={`border-t text-left pt-2 px-0.5 transition-colors ${
                  ...
                  <p className="text-[13px] text-slate-400 leading-relaxed font-semibold" style={{ marginBottom: "0px" }}>
                    ...
                    <span className="block mt-1 text-[#1ed760]/90 font-mono text-[12px] uppercase tracking-wider" style={{ marginBottom: "2px" }}>Measures how closely your acoustic profile matches what Spotify expects for your genre.</span>
                  </p>
                  <span 
                    style={{ paddingTop: "2px" }}
                    className={`inline-block text-[12px] font-mono tracking-widest px-2 py-0.5 rounded-full border transition-all ${
        ...
        <div className="flex flex-col items-center gap-2 py-4">
          <span className="text-[13px] font-mono uppercase tracking-widest text-slate-500 text-center">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6 w-full h-full">
              ...
              <div className="flex flex-col flex-1 justify-between gap-3 h-full">
                ...
                <div className="flex items-center gap-3" style={{ marginBottom: "-9px" }}>
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[13px] text-slate-500 font-medium">Predicted Algorithmic Indexing</span>
                  </div>
                </div>
                ...
                <div className={`border-t text-left pt-2 px-0.5 transition-colors ${
                  ...
                  <p className="text-[13px] text-slate-400 leading-relaxed font-semibold" style={{ marginBottom: "0px" }}>
                    ...
                    <span className="block mt-1 text-violet-400/90 font-mono text-[12px] uppercase tracking-wider" style={{ marginBottom: "2px" }}>Anticipates playlist placement odds, though excluded from your overall score.</span>
                  </p>
                  <span 
                    style={{ paddingTop: "2px" }}
                    className={`inline-block text-[12px] font-mono tracking-widest px-2 py-0.5 rounded-full border transition-all ${
              ...
              <div className="flex-shrink-0 flex items-center justify-center px-4">
                <span className="text-[14px] font-sans font-bold text-white text-center leading-snug max-w-[150px]">
              ...
              <div className="flex flex-col flex-1 justify-between gap-3 h-full">
                ...
                <div className="flex items-center gap-3" style={{ marginBottom: "-9px" }}>
                  ...
                  <div className="flex flex-col text-left">
                    ...
                    <span className="text-[13px] text-slate-500 font-medium">Placement & Retention Simulator</span>
                  </div>
                </div>
                ...
                <div className={`border-t text-left pt-2 px-0.5 transition-colors ${
                  ...
                  <p className="text-[13px] text-slate-400 text-left leading-relaxed font-semibold" style={{ marginBottom: "0px" }}>
                    ...
                    <span className="block mt-1 text-[#fe9a00]/90 font-mono text-[12px] uppercase tracking-wider" style={{ marginBottom: "2px" }}>Simulates how curators and algorithms are likely to place your song.</span>
                  </p>
                  <span 
                    style={{ paddingTop: "2px" }}
                    className={`inline-block text-[12px] font-mono tracking-widest px-2 py-0.5 rounded-full border transition-all ${
        ...
        <div className="pt-2">
          <p className="text-[13px] font-mono text-slate-500 uppercase tracking-widest mb-3 pl-1">The Below Data Is Not Used In the Overall Summary Score</p>
        </div>
              ...
              <div className="flex flex-col flex-1 justify-between gap-3 h-full">
                <div className="flex items-center gap-3" style={{ marginBottom: "-9px" }}>
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[13px] text-slate-500 font-medium">Digital Search Indexing</span>
                  </div>
                </div>
                ...
                <div className={`border-t text-left pt-2 px-0.5 transition-colors ${
                  ...
                  <p className="text-[13px] text-slate-400 leading-relaxed font-semibold" style={{ marginBottom: "0px" }}>
                    ...
                    <span className="block mt-1 text-pink-400/90 font-mono text-[12px] uppercase tracking-wider" style={{ marginBottom: "2px" }}>A real score, scored separately - does not factor into your Streaming Readiness total.</span>
                  </p>
                  <span 
                    style={{ paddingTop: "2px" }}
                    className={`inline-block text-[12px] font-mono tracking-widest px-2 py-0.5 rounded-full border transition-all ${
      ...
      {expandedCategory === "sonic" && (
        ...
        <div className="relative overflow-hidden flex items-center gap-4 pl-5 pr-2 py-3 border-t border-b border-[#46F4CD]/20" style={{ background: "linear-gradient(to right, #090b0e 0%, #090b0e 55%, #091a14 100%)" }}>
          ...
          <span className="relative z-10 text-[12px] font-mono text-slate-500 ml-auto">Technical mix architecture & engineering diagnostics</span>
          <span className="relative z-10 text-[40px] font-black text-white leading-none ml-[24px]" style={{ fontFamily: "Inter, sans-serif" }}>
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 relative z-10 text-center md:text-left">
            ...
            <div>
              <h3 className="text-xl font-bold text-white tracking-wide uppercase flex items-center justify-center md:justify-start gap-2.5">
                ...
                <span className="text-[12px] bg-[#2563EB]/15 border border-[#2563EB]/25 text-blue-400 font-mono tracking-widest px-2.5 py-0.5 rounded-full uppercase">High Precision Analysis</span>
              </h3>
          ...
          <div className="relative z-10 shrink-0">
            <button 
              ...
              className="px-6 py-3 bg-[#2563EB] hover:bg-blue-500 text-white font-mono text-[14px] font-bold uppercase tracking-widest rounded-xl transition-all shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_25px_rgba(37,99,235,0.5)] cursor-pointer flex items-center gap-2 group-hover:scale-102"
            >
                    ...
                    <div className="flex flex-col flex-1 justify-between gap-3 h-full">
                      <div className="flex items-center gap-3" style={{ marginBottom: "-9px" }}>
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-[13px] text-slate-500 font-medium">{mixMetric.subtitle}</span>
                        </div>
                      </div>
                      ...
                      <div className={`border-t text-left pt-2 px-0.5 transition-colors ${
                        ...
                        <p className="text-[13px] text-slate-400 leading-relaxed font-semibold" style={{ marginBottom: "0px" }}>
                          {mixMetric.callout}
                          <span className="block mt-1 text-[#ff66cc]/90 font-mono text-[12px] uppercase tracking-wider" style={{ marginBottom: "2px" }}>Measures whether your mix translates cleanly across playback systems and streaming compression.</span>
                        </p>
                        <span 
                    style={{ paddingTop: "2px" }}
                    className={`inline-block text-[12px] font-mono tracking-widest px-2 py-0.5 rounded-full border transition-all ${
                    ...
                    <div className="flex flex-col flex-1 justify-between gap-3 h-full">
                      <div className="flex items-center gap-3" style={{ marginBottom: "-9px" }}>
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-[13px] text-slate-500 font-medium">{instrumentalMetric.subtitle}</span>
                        </div>
                      </div>
                      ...
                      <div className={`border-t text-left pt-2 px-0.5 transition-colors ${
                        ...
                        <p className="text-[13px] text-slate-400 leading-relaxed font-semibold" style={{ marginBottom: "0px" }}>
                          ...
                          <span className="block mt-1 text-emerald-400/90 font-mono text-[12px] uppercase tracking-wider" style={{ marginBottom: "2px" }}>{instrumentalMetric.hoverText}</span>
                        </p>
                        <span 
                    style={{ paddingTop: "2px" }}
                    className={`inline-block text-[12px] font-mono tracking-widest px-2 py-0.5 rounded-full border transition-all ${
                    ...
                    <div className="flex flex-col flex-1 justify-between gap-3 h-full">
                      <div className="flex items-center gap-3" style={{ marginBottom: "-9px" }}>
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-[13px] text-slate-500 font-medium">{vocalsMetric.subtitle}</span>
                        </div>
                      </div>
                      ...
                      <div className={`border-t text-left pt-2 px-0.5 transition-colors ${
                        ...
                        <p className="text-[13px] text-slate-400 leading-relaxed font-semibold" style={{ marginBottom: "0px" }}>
                          ...
                          <span className="block mt-1 text-[#9999ff]/90 font-mono text-[12px] uppercase tracking-wider" style={{ marginBottom: "2px" }}>Assesses vocal clarity, pitch accuracy, and presence in the mix.</span>
                        </p>
                        <span 
                    style={{ paddingTop: "2px" }}
                    className={`inline-block text-[12px] font-mono tracking-widest px-2 py-0.5 rounded-full border transition-all ${
              ...
              <div className="flex flex-col flex-1 justify-between gap-3 h-full">
                ...
                <div className="flex items-center gap-3" style={{ marginBottom: "-9px" }}>
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[13px] text-slate-500 font-medium">Sonic Fidelity & Engineering Polish</span>
                  </div>
                </div>
                ...
                <div className={`border-t text-left pt-2 px-0.5 transition-colors ${
                  ...
                  <p className="text-[13px] text-slate-400 leading-relaxed font-semibold" style={{ marginBottom: "0px" }}>
                    ...
                    <span className="block mt-1 text-[#46F4CD]/90 font-mono text-[12px] uppercase tracking-wider" style={{ marginBottom: "2px" }}>Reflects overall production polish relative to genre-standard commercial releases.</span>
                  </p>
                  <span 
                    style={{ paddingTop: "2px" }}
                    className={`inline-block text-[12px] font-mono tracking-widest px-2 py-0.5 rounded-full border transition-all ${
              ...
              >
                <div style={{ position: "relative", left: "15px", width: "calc(100% - 15px)" }} className="bg-black/80 border border-[#46F4CD] rounded-3xl p-6 shadow-[0_0_35px_rgba(0,0,0,0.95)] flex flex-col gap-5">
                  ...
                  <div className="p-4 bg-[#020203] border border-white/10 rounded-xl flex flex-col gap-2">
                    ...
                    <p className="text-[13px] text-slate-500 font-mono italic">
                  ...
                  <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6 w-full h-full">
                    <div className="flex flex-col flex-1 justify-between gap-3 h-full">
                      <div className="flex items-center gap-3" style={{ marginBottom: "-9px" }}>
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-[13px] text-slate-500 font-medium">Genre-Aware LUFS &amp; Dynamic Range Matching</span>
                        </div>
                      </div>
                      ...
                      <div className={`border-t text-left pt-2 px-0.5 transition-colors ${
                        ...
                        <p className="text-[13px] text-slate-400 leading-relaxed font-semibold" style={{ marginBottom: "0px" }}>
                          ...
                          <span className="block mt-1 text-blue-400/90 font-mono text-[12px] uppercase tracking-wider" style={{ marginBottom: "2px" }}>A compliance fact, not a creative score - does not factor into your Sonic Soundprint total.</span>
                        </p>
                        <span 
                    style={{ paddingTop: "2px" }}
                    className={`inline-block text-[12px] font-mono tracking-widest px-2 py-0.5 rounded-full border transition-all ${
                    ...
                    <div className="flex-shrink-0 flex items-center justify-center">
                      <div className={`flex flex-col items-center justify-center gap-1.5 w-[110px] h-[110px] rounded-full border-2 ${
                        ...
                        <span className={`text-[14px] font-mono font-black uppercase tracking-wider ${lcBothPass ? "text-emerald-400" : "text-[#ffba00]"}`}>
                  ...
                  {isLoudnessComplianceExpanded && (
                    ...
                    >
                      <div style={{ position: "relative", left: "15px", width: "calc(100% - 15px)" }} className="bg-[#0A0B0E] border border-blue-500 rounded-3xl p-6 shadow-[0_0_35px_rgba(0,0,0,0.95)] flex flex-col gap-5">
                        ...
                        <span className="text-[13px] font-mono text-slate-500 -mt-3">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className={`p-4 rounded-xl border ${lcLufsPass ? "bg-[#0A2010]/35 border-emerald-500/25" : "bg-[#201c10]/30 border-[#ffba00]/15"}`}>
                            <div className="flex items-center justify-between mb-1.5">
                              <span className="text-[13px] font-mono font-bold uppercase tracking-widest text-slate-400">Integrated Loudness</span>
                              <span className={`text-[12px] font-mono font-bold uppercase px-2 py-0.5 rounded-full ${lcLufsPass ? "text-emerald-400 bg-emerald-500/10" : "text-[#ffba00] bg-[#ffba00]/10"}`}>
                          ...
                          <div className={`p-4 rounded-xl border ${lcLraPass ? "bg-[#0A2010]/35 border-emerald-500/25" : "bg-[#201c10]/30 border-[#ffba00]/15"}`}>
                            <div className="flex items-center justify-between mb-1.5">
                              <span className="text-[13px] font-mono font-bold uppercase tracking-widest text-slate-400">Dynamic Range (LRA)</span>
                              <span className={`text-[12px] font-mono font-bold uppercase px-2 py-0.5 rounded-full ${lcLraPass ? "text-emerald-400 bg-emerald-500/10" : "text-[#ffba00] bg-[#ffba00]/10"}`}>
                        ...
                        <p className="text-[13px] text-slate-500 leading-relaxed border-t border-white/5 pt-3">
        ...
        {expandedCategory === "compositional" && (
          ...
          <div className="relative overflow-hidden flex items-center gap-4 pl-5 pr-2 py-3 border-t border-b border-purple-500/20" style={{ background: "linear-gradient(to right, #090b0e 0%, #090b0e 55%, #12091e 100%)" }}>
            ...
            <span className="relative z-10 text-[12px] font-mono text-slate-500 ml-auto">Pacing and dynamics that keep listeners engaged</span>
            <span className="relative z-10 text-[40px] font-black text-white leading-none ml-[24px]" style={{ fontFamily: "Inter, sans-serif" }}>
              ...
              <div className="flex flex-col flex-1 justify-between gap-3 h-full">
                <div className="flex items-center gap-3" style={{ marginBottom: "-9px" }}>
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[13px] text-slate-500 font-medium">Structural Build &amp; Dynamic Arc</span>
                  </div>
                </div>
                ...
                <div className={`border-t text-left pt-2 px-0.5 transition-colors ${
                  ...
                  <p className="text-[13px] text-slate-400 leading-relaxed font-semibold" style={{ marginBottom: "0px" }}>
                    ...
                    <span className="block mt-1 text-amber-500/90 font-mono text-[12px] uppercase tracking-wider" style={{ marginBottom: "2px" }}>Assesses structural pacing and dynamic build across the song, driving 40% of Structural Engagement.</span>
                  </p>
                  <span
                    style={{ paddingTop: "2px" }}
                    className={`inline-block text-[12px] font-mono tracking-widest px-2 py-0.5 rounded-full border transition-all ${
              ...
              >
                <div style={{ position: "relative", left: "15px", width: "calc(100% - 15px)" }} className="bg-[#0A0B0E] border border-amber-500 rounded-3xl p-6 shadow-[0_0_35px_rgba(0,0,0,0.95)] flex flex-col gap-6">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    <div>
                      <div style={{ fontFamily: "Inter, sans-serif", fontWeight: "bold", color: "#ffffff", fontSize: "16px" }} className="flex items-center gap-2">
                        ...
                        <span className="text-[12px] font-mono font-bold uppercase px-2 py-0.5 rounded-full bg-amber-500/10 text-amber-400 border border-amber-500/20">
                          {flowScore >= 80 ? "STRONG MOMENTUM" : flowScore >= 60 ? "BALANCED PACING" : "NEEDS TENSION/RELEASE"}
                        </span>
                      </div>
                      <span className="text-[13px] font-mono text-slate-400 mt-1 block">
                    ...
                    <div className="flex items-baseline gap-1.5 self-start sm:self-auto bg-amber-500/10 border border-amber-500/30 px-3 py-1.5 rounded-xl font-mono">
                      <span className="text-[13px] text-amber-400 font-semibold uppercase tracking-wider">Flow Score:</span>
                  ...
                  <div className="p-4 bg-[#030407] border border-white/10 rounded-2xl flex flex-col gap-3 relative overflow-hidden">
                    <div className="flex items-center justify-between text-[12px] font-mono text-slate-400 uppercase tracking-widest px-1">
                    ...
                    {segments.length < 2 ? (
                      <div className="flex flex-col items-center justify-center py-10 border border-dashed border-white/5 rounded-xl bg-black/40">
                        <span className="text-[14px] text-slate-400 font-medium mb-1">Section transition data pending</span>
                        <p className="text-[13px] text-slate-500 max-w-xs text-center leading-relaxed">
                      ...
                      <div className="flex flex-col gap-2">
                              ...
                              <div key={idx} className="flex flex-col gap-1.5 p-2.5 rounded-xl border border-white/5 bg-black/40 relative overflow-hidden group hover:border-amber-500/30 transition-all">
                                ...
                                <div className="h-16 w-full bg-neutral-900/80 rounded-lg flex items-end p-1 relative border border-white/5 overflow-hidden">
                                  ...
                                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                                    <span className="text-[13px] font-mono font-black text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)]">
                                      {seg.avgDb} <span className="text-[14px] font-normal text-amber-300/80">dB</span>
                                    </span>
                                  </div>
                                </div>

                                {/* Delta Step Indicator */}
                                <div className="flex items-center justify-between text-[12px] font-mono pt-0.5">
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-2 border-t border-white/5 pt-2 text-[12px] font-mono text-slate-400 px-1">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
                    ...
                    <div className="p-4 rounded-xl border border-white/10 bg-[#020203] flex flex-col justify-between">
                      <div className="flex items-center justify-between mb-1.5">
                        <span className="text-[13px] font-mono font-bold uppercase tracking-widest text-amber-400">Section Landmarks</span>
                        <span className="text-[12px] font-mono uppercase px-1.5 py-0.5 rounded bg-amber-500/10 text-amber-400 border border-amber-500/20">DSP Detected</span>
                      </div>
                    ...
                    <div className="p-4 rounded-xl border border-white/10 bg-[#020203] flex flex-col justify-between">
                      <div className="flex items-center justify-between mb-1.5">
                        <span className="text-[13px] font-mono font-bold uppercase tracking-widest text-slate-400">Avg Build Lift</span>
                        <span className="text-[12px] font-mono uppercase px-1.5 py-0.5 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">Impact</span>
                      </div>
                      <div className="text-2xl font-black text-white font-mono mt-1">
                    ...
                    <div className="p-4 rounded-xl border border-amber-500/20 bg-amber-500/5 flex flex-col justify-between">
                      <div className="flex items-center justify-between mb-1.5">
                        <span className="text-[13px] font-mono font-bold uppercase tracking-widest text-slate-400">Pacing Coherence</span>
                        <span className="text-[12px] font-mono font-bold uppercase px-1.5 py-0.5 rounded bg-amber-500/10 text-amber-400">
                  ...
                  <div className="p-4 bg-[#020203] border border-white/10 rounded-xl flex flex-col gap-2">
                    <span className="text-[12px] font-mono font-bold uppercase tracking-widest text-slate-500">AI Transitions &amp; Dynamic Arc Analysis</span>
              ...
              <div className="flex flex-col flex-1 justify-between gap-3 h-full">
                <div className="flex items-center gap-3" style={{ marginBottom: "-9px" }}>
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[13px] text-slate-500 font-medium">Loud/Quiet Contrast Across the Song</span>
                  </div>
                </div>
                ...
                <div className={`border-t text-left pt-2 px-0.5 transition-colors ${
                  ...
                  <p className="text-[13px] text-slate-400 leading-relaxed font-semibold" style={{ marginBottom: "0px" }}>
                    ...
                    <span className="block mt-1 text-rose-500/90 font-mono text-[12px] uppercase tracking-wider" style={{ marginBottom: "2px" }}>Measures loud-quiet contrast across the song, driving 30% of Structural Engagement.</span>
                  </p>
                  <span
                    style={{ paddingTop: "2px" }}
                    className={`inline-block text-[12px] font-mono tracking-widest px-2 py-0.5 rounded-full border transition-all ${
              ...
              <div className="flex-shrink-0 flex items-center justify-center">
                {liveMetrics?.calculatedDynamicModulationScore != null ? (
                  ...
                  <div className="flex items-center justify-center w-[110px] h-[110px] rounded-full border border-dashed border-rose-500/30">
                    <span className="text-[12px] font-mono text-slate-500 text-center px-3 uppercase tracking-wide">Insufficient Real Data</span>
                  </div>
                )}
              </div>
            </div>
              ...
              >
                <div style={{ position: "relative", left: "15px", width: "calc(100% - 15px)" }} className="bg-[#0A0B0E] border border-rose-500 rounded-3xl p-6 shadow-[0_0_35px_rgba(0,0,0,0.95)] flex flex-col gap-6">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    <div>
                      <div style={{ fontFamily: "Inter, sans-serif", fontWeight: "bold", color: "#ffffff", fontSize: "16px" }} className="flex items-center gap-2">
                        ...
                        <span className={`text-[12px] font-mono font-bold uppercase px-2 py-0.5 rounded-full ${dmTier.bg} ${dmTier.color} border ${dmTier.border}`}>
                          {dmTier.label}
                        </span>
                      </div>
                      <span className="text-[13px] font-mono text-slate-400 mt-1 block">
                    ...
                    {dRangeDb != null && (
                      <div className="flex items-baseline gap-1.5 self-start sm:self-auto bg-rose-500/10 border border-rose-500/30 px-3 py-1.5 rounded-xl font-mono">
                        <span className="text-[13px] text-rose-400 font-semibold uppercase tracking-wider">Dynamic Span:</span>
                  ...
                  <div className="p-4 bg-[#030407] border border-white/10 rounded-2xl flex flex-col gap-2 relative overflow-hidden">
                    ...
                    <div className="w-full relative">
                      {envelopePoints.length < 2 ? (
                        <div className="flex flex-col items-center justify-center py-10 border border-dashed border-white/5 rounded-xl bg-black/40">
                          <span className="text-[14px] text-slate-400 font-medium mb-1">No real envelope data available</span>
                          <p className="text-[13px] text-slate-500 max-w-xs text-center leading-relaxed">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
                    ...
                    <div className="p-4 rounded-xl border border-white/10 bg-[#020203] flex flex-col justify-between">
                      <div className="flex items-center justify-between mb-1.5">
                        <span className="text-[13px] font-mono font-bold uppercase tracking-widest text-rose-400">Peak Energy (85th %)</span>
                        <span className="text-[12px] font-mono uppercase px-1.5 py-0.5 rounded bg-rose-500/10 text-rose-400 border border-rose-500/20">Choruses / Drops</span>
                      </div>
                      <div className="text-2xl font-black text-white font-mono mt-1">
                    ...
                    <div className="p-4 rounded-xl border border-white/10 bg-[#020203] flex flex-col justify-between">
                      <div className="flex items-center justify-between mb-1.5">
                        <span className="text-[13px] font-mono font-bold uppercase tracking-widest text-slate-400">Baseline Floor (15th %)</span>
                        <span className="text-[12px] font-mono uppercase px-1.5 py-0.5 rounded bg-slate-800 text-slate-400 border border-white/10">Verses / Intro</span>
                      </div>
                      <div className="text-2xl font-black text-white font-mono mt-1">
                    ...
                    <div className={`p-4 rounded-xl border ${dmTier.bg} ${dmTier.border} flex flex-col justify-between`}>
                      <div className="flex items-center justify-between mb-1.5">
                        <span className="text-[13px] font-mono font-bold uppercase tracking-widest text-slate-400">Macro Contrast (Δ)</span>
                        <span className={`text-[12px] font-mono font-bold uppercase px-1.5 py-0.5 rounded ${dmTier.bg} ${dmTier.color}`}>
                          {dmTier.label}
                        </span>
                      </div>
                      <div className="text-2xl font-black text-white font-mono mt-1">
                  ...
                  <div className="p-4 bg-[#020203] border border-white/10 rounded-xl flex flex-col gap-3">
                    ...
                    <div className="relative pt-6 pb-2">
                      ...
                      {dRangeDb != null && (
                        ...
                        >
                          <span className="text-[11px] font-mono font-bold text-white px-1.5 py-0.5 rounded bg-rose-500 shadow-[0_0_8px_rgba(244,63,94,0.8)] whitespace-nowrap mb-0.5">
                      ...
                      {/* Zone Labels */}
                      <div className="flex justify-between text-[12px] font-mono text-slate-500 mt-2 px-0.5">
              ...
              <div className="flex flex-col flex-1 justify-between gap-3 h-full">
                <div className="flex items-center gap-3" style={{ marginBottom: "-9px" }}>
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[13px] text-slate-500 font-medium">Does The Song Build Toward A Peak?</span>
                  </div>
                </div>
                ...
                <div className={`border-t text-left pt-2 px-0.5 transition-colors ${
                  ...
                  <p className="text-[13px] text-slate-400 leading-relaxed font-semibold" style={{ marginBottom: "0px" }}>
                    ...
                    <span className="block mt-1 text-teal-500/90 font-mono text-[12px] uppercase tracking-wider" style={{ marginBottom: "2px" }}>Tracks whether the song genuinely builds toward a late peak, driving 30% of Structural Engagement.</span>
                  </p>
                  <span
                    style={{ paddingTop: "2px" }}
                    className={`inline-block text-[12px] font-mono tracking-widest px-2 py-0.5 rounded-full border transition-all ${
              ...
              >
                <div style={{ position: "relative", left: "15px", width: "calc(100% - 15px)" }} className="bg-[#0A0B0E] border border-teal-500 rounded-3xl p-6 shadow-[0_0_35px_rgba(0,0,0,0.95)] flex flex-col gap-5">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    ...
                    <span className="text-[12px] font-mono uppercase px-2.5 py-1 rounded-full bg-teal-500/10 text-teal-400 border border-teal-500/20 font-bold self-start sm:self-auto">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
                    ...
                    <div className={`p-4 rounded-xl border ${posTier.bg} ${posTier.border} flex flex-col justify-between`}>
                      <div className="flex items-center justify-between mb-1.5">
                        <span className="text-[13px] font-mono font-bold uppercase tracking-widest text-slate-400">Peak Position</span>
                        <span className={`text-[12px] font-mono font-bold uppercase px-1.5 py-0.5 rounded ${posTier.bg} ${posTier.color}`}>
                          {posTier.label}
                        </span>
                      </div>
                      <div className="text-2xl font-black text-white font-mono mt-1">
                    ...
                    <div className={`p-4 rounded-xl border ${magTier.bg} ${magTier.border} flex flex-col justify-between`}>
                      <div className="flex items-center justify-between mb-1.5">
                        <span className="text-[13px] font-mono font-bold uppercase tracking-widest text-slate-400">Build Magnitude</span>
                        <span className={`text-[12px] font-mono font-bold uppercase px-1.5 py-0.5 rounded ${magTier.bg} ${magTier.color}`}>
                          {magTier.label}
                        </span>
                      </div>
                      <div className="text-2xl font-black text-white font-mono mt-1">
                    ...
                    <div className="p-4 rounded-xl border border-teal-500/20 bg-teal-500/5 flex flex-col justify-between">
                      <div className="flex items-center justify-between mb-1.5">
                        <span className="text-[13px] font-mono font-bold uppercase tracking-widest text-slate-400">Climax Trajectory</span>
                        <span className="text-[12px] font-mono font-bold uppercase px-1.5 py-0.5 rounded bg-teal-500/10 text-teal-400">
                  ...
                  <div className="p-4 bg-[#020203] border border-white/10 rounded-xl flex flex-col gap-3">
                    ...
                    <div className="relative pt-6 pb-2">
                      ...
                      {posRatio != null && (
                        ...
                        >
                          <span className="text-[11px] font-mono font-bold text-white px-1.5 py-0.5 rounded bg-teal-500 shadow-[0_0_8px_rgba(20,184,166,0.8)] whitespace-nowrap mb-0.5">
                  ...
                  <div className="p-4 bg-[#020203] border border-white/10 rounded-xl flex flex-col gap-2">
                    <span className="text-[12px] font-mono font-bold uppercase tracking-widest text-slate-500">Structural Arc &amp; Momentum Assessment</span>
                    <p className="text-[14px] text-slate-300 leading-relaxed">
        ...
        {expandedCategory === "compositionaldepth" && (
          <div id="section-compositionaldepth" className="flex flex-col gap-4 mt-8">
            ...
            <div className="relative z-10 flex flex-col gap-0.5">
              <span className="text-[12px] font-mono font-bold text-slate-400 uppercase tracking-[0.2em]">Additional Insights</span>
            ...
            <span className="relative z-10 text-[12px] font-mono text-slate-500 ml-auto">Not used in your overall summary score</span>
          </div>
        ...
        <div className="flex flex-col w-full gap-4" id="sidebar-link-compositional-3">
          {(() => {
            const theoryMetric = AUX_METRICS_LIST.find(m => m.id === "theory");
            if (!theoryMetric) return null;
            const isExpanded = expandedMetric === "theory";
            return (
              <>
                <button
                ...
                >
                  {isExpanded ? (
                    <div className="absolute inset-0 bg-gradient-to-br from-[#818cf8]/10 via-neutral-950 to-[#03050a] pointer-events-none" />
                  ) : (
                    <div className="absolute inset-0 bg-gradient-to-br from-neutral-950 to-[#03050a] pointer-events-none" />
                  )}
                  ...
                  <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6 w-full h-full">
                    <div className="flex flex-col flex-1 justify-between gap-3 h-full">
                      <div className="flex items-center gap-3" style={{ marginBottom: "-9px" }}>
                        <div className={`p-2 rounded-xl border flex-shrink-0 flex items-center justify-center transition-all ${
                          isExpanded
                            ? "bg-[#818cf8]/10 border-[#818cf8]/30 text-[#818cf8] shadow-[0_0_15px_rgba(129,140,248,0.3)]"
                            : "bg-neutral-900 border-white/5 text-slate-500 group-hover:text-[#818cf8]"
                        }`}>
                          <Music4 className="w-5 h-5 text-[#818cf8]" />
                        </div>
                        <div className="flex flex-col">
                          <span className={`font-black text-[19px] tracking-wider uppercase transition-colors ${
                            isExpanded ? "text-white" : "text-slate-400 group-hover:text-slate-200"
                          ...
                          <span className="text-[13px] text-slate-500 font-medium">{theoryMetric.subtitle}</span>
                        </div>
                      </div>
                      ...
                      <div className={`border-t text-left pt-2 px-0.5 transition-colors ${
                        ...
                        <p className="text-[13px] text-slate-400 leading-relaxed font-semibold" style={{ marginBottom: "0px" }}>
                          ...
                          <span className="block mt-1 text-[#818cf8]/90 font-mono text-[12px] uppercase tracking-wider" style={{ marginBottom: "2px" }}>Assesses harmonic craft and musicological structure, though not factored into your overall score.</span>
                        </p>
                        <span
                          style={{ paddingTop: "2px" }}
                          className={`inline-block text-[12px] font-mono tracking-widest px-2 py-0.5 rounded-full border transition-all ${
                    ...
                    <div className="flex-shrink-0 flex items-center justify-center">
                      <ScoreCircle
                        score={theoryMetric.score}
                        size={110}
                        strokeWidth={7}
                        color={isExpanded ? "#818cf8" : "rgba(129, 140, 248, 0.45)"}
                        glowColor={isExpanded ? "rgba(129, 140, 248, 0.65)" : "rgba(129, 140, 248, 0.15)"}
                        extraGlow={isExpanded}
                      />
                    </div>
                  </div>
                  ...
                  return (
                    <div style={{ position: "relative", left: "15px", width: "calc(100% - 15px)" }} className="bg-[#0A0B0E] border border-[#818cf8]/30 rounded-3xl p-5 mt-3 flex flex-col gap-2">
                      <div className="flex items-center justify-between">
                        <span className="text-[13px] font-mono font-bold uppercase tracking-widest text-[#818cf8]">AI-Detected Key &amp; Chord Vocabulary</span>
                        <span className="text-[12px] font-mono text-slate-500 uppercase text-right">Direct Gemini audio analysis, not DSP measurement</span>
                      </div>
                      {analysis?.keySignature ? (
                        <>
                          ...
                          <div className="flex flex-wrap gap-1.5 mt-1">
                            {chordsUsed.map((c: any, i: number) => (
                              <span key={i} className="text-[13px] font-mono text-slate-300 bg-[#818cf8]/10 border border-[#818cf8]/20 rounded-full px-2 py-0.5">
                        ...
                        <p className="text-[13px] text-slate-500">No AI chord/key analysis available for this track yet.</p>
                      )}
                    </div>
                  );
                })()}
                    ...
                    <div className="flex flex-col flex-1 justify-between gap-3 h-full">
                      <div className="flex items-center gap-3" style={{ marginBottom: "-9px" }}>
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-[13px] text-slate-500 font-medium">{lyricsMetric.subtitle}</span>
                        </div>
                      </div>
                      ...
                      <div className={`border-t text-left pt-2 px-0.5 transition-colors ${
                        ...
                        <p className="text-[13px] text-slate-400 leading-relaxed font-semibold" style={{ marginBottom: "0px" }}>
                          ...
                          <span className="block mt-1 text-cyan-400/90 font-mono text-[12px] uppercase tracking-wider" style={{ marginBottom: "2px" }}>Assesses lyrical clarity and originality, though not factored into your overall score.</span>
                        </p>
                        <span
                          style={{ paddingTop: "2px" }}
                          className={`inline-block text-[12px] font-mono tracking-widest px-2 py-0.5 rounded-full border transition-all ${
              ...
              <div className="flex flex-col flex-1 justify-between gap-3 h-full">
                ...
                <div className="flex items-center gap-3" style={{ marginBottom: "-9px" }}>
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[13px] text-slate-500 font-medium">Architecture & Music Theory Application</span>
                  </div>
                </div>
                ...
                <div className={`border-t text-left pt-2 px-0.5 transition-colors ${
                  ...
                  <p className="text-[13px] text-slate-400 leading-relaxed font-semibold" style={{ marginBottom: "0px" }}>
                    ...
                    <span className="block mt-1 text-purple-400/90 font-mono text-[12px] uppercase tracking-wider" style={{ marginBottom: "2px" }}>Reflects artistic ambition and creative depth, though not factored into streaming algorithms.</span>
                  </p>
                  <span 
                    style={{ paddingTop: "2px" }}
                    className={`inline-block text-[12px] font-mono tracking-widest px-2 py-0.5 rounded-full border transition-all ${
              ...
              <div className="flex flex-col flex-1 justify-between gap-3 h-full">
                ...
                <div className="flex items-center gap-3" style={{ marginBottom: "-9px" }}>
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[13px] text-slate-500 font-medium">Structural Mechanics</span>
                  </div>
                </div>
                ...
                <div className={`border-t text-left pt-2 px-0.5 transition-colors ${
                  ...
                  <p className="text-[13px] text-slate-400 leading-relaxed font-semibold" style={{ marginBottom: "0px" }}>
                    ...
                    <span className="block mt-1 text-emerald-400/90 font-mono text-[12px] uppercase tracking-wider" style={{ marginBottom: "2px" }}>Assesses core songwriting strength, though not factored into streaming algorithms.</span>
                  </p>
                  <span 
                    style={{ paddingTop: "2px" }}
                    className={`inline-block text-[12px] font-mono tracking-widest px-2 py-0.5 rounded-full border transition-all ${
              ...
              <div className="flex flex-col flex-1 justify-between gap-3 h-full">
                ...
                <div className="flex items-center gap-3" style={{ marginBottom: "-9px" }}>
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[13px] text-slate-500 font-medium">Structural Timeline & Section Map</span>
                  </div>
                </div>
                ...
                <div className={`border-t text-left pt-2 px-0.5 transition-colors ${
                  ...
                  <p className="text-[13px] text-slate-400 leading-relaxed font-semibold" style={{ marginBottom: "0px" }}>
                    ...
                    <span className="block mt-1 text-violet-400/90 font-mono text-[12px] uppercase tracking-wider" style={{ marginBottom: "2px" }}>Visualizes your track's pacing and hook placement, though not factored into streaming algorithms.</span>
                  </p>
                  <span 
                    style={{ paddingTop: "2px" }}
                    className={`inline-block text-[12px] font-mono tracking-widest px-2 py-0.5 rounded-full border transition-all ${
                  ...
                  <div className="flex flex-col gap-6 relative">
                    ...
                    <div className="bg-[#0e1115]/80 border border-white/5 rounded-2xl p-5 shadow-inner">
                      <div className="flex justify-between items-center mb-3.5">
                        <span className="text-[13px] font-mono text-violet-400 uppercase font-bold tracking-widest flex items-center gap-1.5">
                          <Activity className="w-3.5 h-3.5" />
                          Section Map & Progression
                        </span>
                        <span className="text-[12px] font-mono text-slate-500">Based on analyzed loudness envelope</span>
                      </div>
                      {(() => {
                        ...
                        if (points.length === 0 || duration === 0) {
                          return (
                            <div className="flex flex-col items-center justify-center py-6 border border-dashed border-white/5 rounded-xl bg-black/40">
                              <span className="text-[14px] text-slate-400 font-medium mb-1">No audio data found</span>
                              <p className="text-[13px] text-slate-500 max-w-xs text-center leading-relaxed">
                        ...
                        return (
                          <div className="flex flex-col gap-4">
                            {/* LUFS label */}
                            <div className="text-[12px] font-mono text-slate-500 uppercase tracking-widest mb-1">Loudness</div>
                              ...
                              <div className="absolute left-0 right-0 top-0 flex flex-col justify-between pointer-events-none" style={{ height: `${chartHeight}px` }}>
                                {[maxLufs, (maxLufs + minLufs) / 2, minLufs].map((v, i) => (
                                  <div key={i} className="flex items-center gap-2">
                                    <span className="text-[12px] font-mono text-slate-600 w-10 text-right flex-shrink-0">{v.toFixed(1)}dB</span>
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1.5 hidden group-hover/bar:flex flex-col items-center z-30 pointer-events-none">
                                          <div className="bg-neutral-900 border border-white/10 px-2 py-1 rounded-md text-[12px] font-mono text-white whitespace-nowrap shadow-2xl">
                                      ...
                                      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-full flex flex-col items-center pt-1.5" style={{ width: 'max-content' }}>
                                        <span className="text-[12px] font-mono text-slate-500">{s.fmt(s.startTime)}</span>
                                        <span className={`text-[12px] font-mono font-bold mt-0.5`} style={{ color }}>{s.label}</span>
                                        {hookEarly && (
                                          <span className="text-[11px] font-mono text-amber-400 bg-amber-500/10 border border-amber-500/20 px-1 py-0.5 rounded mt-0.5 whitespace-nowrap">
                      ...
                      <div className="bg-[#0e1115]/80 border border-white/5 rounded-2xl p-5 shadow-inner flex flex-col justify-between">
                        <div>
                          <div className="flex justify-between items-center mb-3">
                            ...
                            <span className="text-[12px] font-mono text-slate-500">First 30s analysis</span>
                          </div>
                          {(() => {
                            const points = liveMetrics?.calculatedWaveformPointsHD ?? liveMetrics?.calculatedWaveformPoints ?? [];
                            const duration = liveMetrics?.calculatedDuration ?? 0;
                            if (points.length === 0 || duration === 0) {
                              return <div className="text-[13px] text-slate-600 font-mono py-4">Upload a track to analyze hooks.</div>;
                            }
                        ...
                        const overallPeak = Math.max(...points);
                            ...
                            return (
                              <div className="flex flex-col gap-3">
                                <div className="flex items-center justify-between">
                                  <span className="text-[13px] text-slate-400">Energy ratio in first 30 seconds</span>
                                ...
                                <p className="text-[13px] text-slate-400 leading-relaxed bg-black/30 border border-white/[0.02] rounded-xl p-3 mt-1.5 font-sans">
                                  {hookScore > 70 ? (
                                    <>
                      ...
                      <div className="bg-[#0e1115]/80 border border-white/5 rounded-2xl p-5 shadow-inner flex flex-col justify-between">
                        <div>
                          <div className="flex justify-between items-center mb-3">
                            ...
                            <span className="text-[12px] font-mono text-slate-500">Chorus vs. Verse Delta</span>
                          </div>
                          {(() => {
                            const points = liveMetrics?.calculatedWaveformPointsHD ?? liveMetrics?.calculatedWaveformPoints ?? [];
                            const lufs = liveMetrics?.calculatedLufs ?? -12;
                            if (points.length === 0) {
                              return <div className="text-[13px] text-slate-600 font-mono py-4">Upload a track to analyze dynamics.</div>;
                            }
                            ...
                            return (
                              <div className="flex flex-col gap-3">
                                <div className="flex flex-col gap-2 bg-black/40 border border-white/[0.02] p-3 rounded-xl font-mono">
                                  ...
                                  <div className="flex items-center justify-between text-[14px] border-t border-white/5 pt-2 mt-1">
                                ...
                                <p className="text-[13px] text-slate-400 leading-relaxed bg-black/30 border border-white/[0.02] rounded-xl p-3 font-sans">
                                  {diff > 2 ? (
                                    <>
      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-center gap-6 relative z-10 text-center md:text-left">
          ...
          <div>
            <h3 className="text-xl font-bold text-white tracking-wide uppercase flex items-center justify-center md:justify-start gap-2.5">
              ...
              <span className="text-[12px] bg-blue-500/15 border border-blue-500/25 text-blue-400 font-mono tracking-widest px-2.5 py-0.5 rounded-full uppercase">Strategic AI Suite</span>
            </h3>
        ...
        <div className="relative z-10 shrink-0">
          <button 
            ...
            className="px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white font-mono text-[14px] font-bold uppercase tracking-widest rounded-xl transition-all shadow-[0_0_15px_rgba(59,130,246,0.3)] hover:shadow-[0_0_25px_rgba(59,130,246,0.5)] cursor-pointer flex items-center gap-2 group-hover:scale-102"
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              <h2 className="text-lg font-bold text-white tracking-wide uppercase flex items-center gap-2">
                ...
                <span className="text-[12px] bg-blue-500/10 border border-blue-500/20 text-blue-400 font-mono tracking-widest px-2 py-0.5 rounded-full uppercase">Ask Your Rep</span>
              </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10 items-stretch">
          ...
          <div className="lg:col-span-4 flex flex-col gap-4">
            <div className="text-left mb-1.5">
              <span className="text-[13px] font-mono tracking-widest text-slate-400 uppercase font-black">
                  ...
                  >
                    ...
                    <div className="flex flex-col flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[12px] font-mono tracking-widest text-slate-500 uppercase font-black">
                    ...
                    <div className="flex-shrink-0">
                      <span className={`text-[13px] uppercase font-mono font-bold px-2 py-0.5 rounded-full border transition-all ${
                        isSelected 
          ...
          <div className="lg:col-span-8 flex flex-col bg-[#07080a] border border-white/5 rounded-2xl overflow-hidden min-h-[480px]">
            ...
            <div className="p-4 bg-black border-b border-white/5 flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-[13px] text-slate-400 max-w-md line-clamp-1">
              ...
              <button
                ...
                className="px-2.5 py-1.5 bg-neutral-900 hover:bg-neutral-800 border border-white/5 text-slate-400 hover:text-slate-200 text-[13px] font-mono rounded-lg transition-all cursor-pointer"
              >
                Clear Chats
              </button>
            </div>
            ...
            <div className="flex-1 p-5 overflow-y-auto flex flex-col gap-4 font-sans text-xs bg-gradient-to-b from-[#07080a] to-[#040507] text-left max-h-[340px]" id="rep-messages-box">
                ...
                if (isSystem) {
                  return (
                    <div key={index} className="flex justify-center my-1 select-none animate-fadeIn">
                      <span className="px-3.5 py-1.5 bg-red-950/20 border border-red-500/20 text-red-400 rounded-xl text-[13px] font-semibold flex items-center gap-1.5 font-mono shadow-inner">
                        {msg.text}
                      </span>
                    </div>
                  );
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      <div className={`flex items-center gap-2 mb-1 justify-start ${isUser ? "flex-row-reverse" : "flex-row"}`}>
                        <span className="font-bold text-[14px] text-slate-300">
                          {msg.senderName}
                        </span>
                        <span className="text-[12px] font-mono text-slate-600 font-medium select-none">
              ...
              {isConsulting && (
                <div className="flex items-start gap-3 max-w-[85%] self-start animate-pulse">
                  ...
                  <div className="flex flex-col">
                    <span className="font-bold text-[14px] text-slate-500 mb-1 block">
            ...
            <div className="px-4 py-2 bg-neutral-950 border-t border-white/5 flex flex-wrap gap-2 text-left justify-start">
              <span className="text-[13px] font-mono text-slate-500 uppercase font-bold flex items-center gap-1 py-1 mr-1.5 select-none">
              ...
              {[
                ...
                <button
                  ...
                  className="px-2.5 py-1 bg-[#13161C] hover:bg-white/5 border border-white/5 hover:border-white/12 text-[13px] text-slate-400 hover:text-slate-200 rounded-lg transition-all cursor-pointer font-medium disabled:opacity-50"
                >
                  {sug.label}
                </button>
              ))}
    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-wrap items-center justify-center gap-1.5 bg-neutral-900/60 p-2 border border-white/5 rounded-xl">
        <button
          ...
          className={`px-3 py-1.5 rounded-lg text-[13px] font-mono font-bold uppercase transition-all tracking-wider ${
            activeTab === "outline"
        ...
        <button
          ...
          className={`px-3 py-1.5 rounded-lg text-[13px] font-mono font-semibold uppercase transition-all tracking-widest ${
            activeTab === "azimuth"
