...
export default function App() {
    ...
    const saveActiveCritiqueToLocker = async () => {
      try {
        ...
        const newLockerTrack: StoredTrack = {
          ...
          convertedMp3Url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3",
  ...
  const handleAuditQueuedTrack = async (track: StoredTrack) => {
    ...
    try {
      ...
      let liveMetrics;
      try {
        const audioBuffer = await decodeAudioUrl(urlToAnalyze);
        liveMetrics = analyzeAudioBuffer(audioBuffer);
          ...
          <div className="flex flex-col items-center sm:items-end gap-2 text-right">
            <div className="flex items-center gap-2 flex-wrap justify-center sm:justify-end">
              ...
              >
                ...
                <span>What YourSongScore is</span>
              </button>
              ...
              >
                ...
                <span>What YourSongScore does</span>
              </button>
