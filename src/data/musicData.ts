...
export const SUBGENRE_PROFILES: Record<string, SubgenreProfile> = {
  ...
  "rock|punk / post-punk": {
    genre: "Rock",
    subgenre: "Punk / Post-Punk",
    archetype: "HIGH_GAIN",
    danceMin: 0.30, danceMax: 0.55,
    bpmMin: 140, bpmMax: 200,
    energyMin: 0.80, energyMax: 0.99,
    crestMin: 4, crestMax: 8,
    valenceMin: 0.35, valenceMax: 0.80,
    speechMin: 0.04, speechMax: 0.12,
    acousticMin: 0.00, acousticMax: 0.08,
    instMin: 0.00, instMax: 0.12,
    liveMin: 0.10, liveMax: 0.40
  },
  "rock|progressive rock / art rock": {
    genre: "Rock",
    subgenre: "Progressive Rock / Art Rock",
    archetype: "MID_GAIN",
    danceMin: 0.25, danceMax: 0.50,
    bpmMin: 70, bpmMax: 150,
    energyMin: 0.40, energyMax: 0.80,
    crestMin: 8, crestMax: 14,
    valenceMin: 0.15, valenceMax: 0.55,
    speechMin: 0.02, speechMax: 0.06,
    acousticMin: 0.03, acousticMax: 0.35,
    instMin: 0.10, instMax: 0.60,
    liveMin: 0.06, liveMax: 0.25
  },
  "rock|new wave / power pop": {
    genre: "Rock",
    subgenre: "New Wave / Power Pop",
    archetype: "MID_GAIN",
    danceMin: 0.45, danceMax: 0.72,
    bpmMin: 118, bpmMax: 165,
    energyMin: 0.60, energyMax: 0.88,
    crestMin: 6, crestMax: 10,
    valenceMin: 0.45, valenceMax: 0.85,
    speechMin: 0.03, speechMax: 0.07,
    acousticMin: 0.01, acousticMax: 0.15,
    instMin: 0.01, instMax: 0.20,
    liveMin: 0.06, liveMax: 0.22
  },
  "rock|psychedelic rock": {
    ...
    archetype: "MID_GAIN",
    danceMin: 0.30, danceMax: 0.58,
    bpmMin: 75, bpmMax: 140,
    energyMin: 0.40, energyMax: 0.80,
    crestMin: 7, crestMax: 13,
    valenceMin: 0.20, valenceMax: 0.65,
    speechMin: 0.02, speechMax: 0.06,
    acousticMin: 0.03, acousticMax: 0.35,
    instMin: 0.05, instMax: 0.45,
    liveMin: 0.08, liveMax: 0.30
  },
  "folk / singer-songwriter|folk rock": {
    genre: "Folk / Singer-Songwriter",
    subgenre: "Folk Rock",
    archetype: "ORGANIC_TRAN",
    danceMin: 0.30, danceMax: 0.60,
    bpmMin: 70, bpmMax: 140,
    energyMin: 0.25, energyMax: 0.65,
    crestMin: 9, crestMax: 15,
    valenceMin: 0.20, valenceMax: 0.70,
    speechMin: 0.02, speechMax: 0.07,
    acousticMin: 0.25, acousticMax: 0.85,
    instMin: 0.00, instMax: 0.20,
    liveMin: 0.06, liveMax: 0.25
  },
  "folk / singer-songwriter|contemporary folk": {
    genre: "Folk / Singer-Songwriter",
    subgenre: "Contemporary Folk",
    archetype: "ORGANIC_TRAN",
    danceMin: 0.30, danceMax: 0.62,
    bpmMin: 70, bpmMax: 140,
    energyMin: 0.25, energyMax: 0.68,
    crestMin: 9, crestMax: 15,
    valenceMin: 0.25, valenceMax: 0.75,
    speechMin: 0.02, speechMax: 0.07,
    acousticMin: 0.25, acousticMax: 0.85,
    instMin: 0.00, instMax: 0.20,
    liveMin: 0.06, liveMax: 0.25
  ...
  "folk / singer-songwriter|singer-songwriter": {
    ...
    archetype: "ORGANIC_TRAN",
    danceMin: 0.28, danceMax: 0.58,
    bpmMin: 60, bpmMax: 130,
    energyMin: 0.15, energyMax: 0.55,
    crestMin: 10, crestMax: 17,
    valenceMin: 0.15, valenceMax: 0.65,
    speechMin: 0.02, speechMax: 0.07,
    acousticMin: 0.40, acousticMax: 0.95,
    instMin: 0.00, instMax: 0.15,
    liveMin: 0.06, liveMax: 0.28
  },
  "folk / singer-songwriter|traditional folk": {
    genre: "Folk / Singer-Songwriter",
    subgenre: "Traditional Folk",
    archetype: "ORGANIC_TRAN",
    danceMin: 0.25, danceMax: 0.55,
    bpmMin: 60, bpmMax: 130,
    energyMin: 0.12, energyMax: 0.50,
    crestMin: 10, crestMax: 18,
    valenceMin: 0.20, valenceMax: 0.70,
    speechMin: 0.02, speechMax: 0.08,
    acousticMin: 0.55, acousticMax: 0.98,
    instMin: 0.00, instMax: 0.25,
    liveMin: 0.08, liveMax: 0.35
  },
...
export const VECTOR_TARGETS: Record<string, { pitch: string; timbre: string; loudness: string }> = {
  ...
  "Folk / Singer-Songwriter": {
    pitch: "Natural Human Contour: Unprocessed vocal pitch with audible, expressive micro-variation; acoustic string and fingerpicked movement rather than quantised or tuned lines.",
    timbre: "Organic Wood and Air: Acoustic guitar body resonance, close-mic'd breath and finger noise, minimal electronic processing; warmth carried by real instrument overtones rather than synthesis.",
    loudness: "Preserved Dynamics: Genuine soft-to-loud movement retained across verses and choruses; comparatively light limiting, so quiet passages stay quiet rather than being pushed up to a constant level."
  },
  "World Music": {
...
export function getSubgenreProfile(genreName: string, subgenreName: string): SubgenreProfile {
  ...
  const GENRE_DEFAULT_PROFILE: Record<string, string> = {
    ...
    "post-punk": "rock|punk / post-punk",
    "prog": "rock|progressive rock / art rock",
    "progressive rock": "rock|progressive rock / art rock",
    "art rock": "rock|progressive rock / art rock",
    "new wave": "rock|new wave / power pop",
    "power pop": "rock|new wave / power pop",
    "psychedelic": "rock|psychedelic rock",
    "psychedelic rock": "rock|psychedelic rock",
    "folk": "folk / singer-songwriter|folk rock",
    "folk rock": "folk / singer-songwriter|folk rock",
    "folk / singer-songwriter": "folk / singer-songwriter|folk rock",
    "singer-songwriter": "folk / singer-songwriter|singer-songwriter",
